...
#' @details In case of ties, or if length(x) == 1, will return the first value.
...
#' @return The most frequent value in x, or see details for exception cases.
#' Will throw a warning if length(unique(x) == length(x)).
#' @export
#' @examples
